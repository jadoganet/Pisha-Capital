...
export const BUSINESS_DATA: HoldingData = {
  ...
  portfolio: [
    { name: "Siemprelleno.com", url: "Siemprelleno.com", model: "App que garantiza clientes en la apertura y primeras horas de los negocios mediante promociones dinámicas.", market: "Restauración, retail, gimnasios y ocio.", advantage: "Genera consumo inmediato → “llenar desde el minuto 1”.", projection: "50.000 negocios activos en España y LATAM.", revenue: 15, icon: <AlwaysFullIcon />, videoUrl: "https://videos.pexels.com/video-files/5776269/5776290-hd_1920_1080_25fps.mp4" },
    { name: "BNB65.com", url: "BNB65.com", model: "Alojamiento + experiencias para +65 años.", market: "Turismo sénior (uno de los de mayor crecimiento en Europa).", advantage: "Especialización en accesibilidad, seguridad y actividades adaptadas.", projection: "20.000 reservas mensuales en Europa.", revenue: 12, icon: <Bnb65Icon />, videoUrl: "https://videos.pexels.com/video-files/854045/854045-hd_1366_720_25fps.mp4" },
    { name: "Cannaviajes.com", url: "Cannaviajes.com", model: "Agencia de viajes temática en torno al turismo cannábico y experiencias relacionadas.", market: "Turismo alternativo y emergente en países con legislación favorable.", advantage: "Primer player en España y LATAM.", projection: "10.000 reservas anuales.", revenue: 5, icon: <CannaViajesIcon />, videoUrl: "https://videos.pexels.com/video-files/854045/854045-hd_1366_720_25fps.mp4" },
    { name: "SalsaVR.com", url: "SalsaVR.com", model: "Plataforma de clases y experiencias de baile en realidad virtual.", market: "Entretenimiento, fitness y e-learning.", advantage: "Experiencias inmersivas, comunidad global.", projection: "1M usuarios activos.", revenue: 8, icon: <SalsaVRIcon />, videoUrl: "https://videos.pexels.com/video-files/4434230/4434230-hd_1920_1080_25fps.mp4" },
    { name: "Reto360.com", url: "Reto360.com", model: "Experiencias de retos y gamificación en 360º y VR para eventos, ocio y turismo.", market: "Eventos, formación, turismo de experiencias.", advantage: "Producto viral y adaptable a sectores B2B y B2C.", projection: "500 clientes B2B + 100k usuarios B2C.", revenue: 6, icon: <Reto360Icon />, videoUrl: "https://videos.pexels.com/video-files/3214479/3214479-hd_1280_720_25fps.mp4" },
    { name: "CadizAvanza.com", url: "CadizAvanza.com", model: "Gestión de alquileres turísticos + agencia de marketing y consultoría con IA.", market: "Propietarios de viviendas turísticas + pymes locales.", advantage: "Branding local + digitalización con IA.", projection: "1.000 propiedades gestionadas.", revenue: 4, icon: <CadizAvanzaIcon />, videoUrl: "https://videos.pexels.com/video-files/3254013/3254013-hd_1920_1080_24fps.mp4" },
    { name: "ChorizoPortuano.es", url: "ChorizoPortuano.es", model: "Marca humorística de merchandising y regalos.", market: "E-commerce y B2B para campañas.", advantage: "Disruptivo, viral, posicionamiento de humor ácido.", projection: "100k ventas anuales.", revenue: 2, icon: <ChorizoPortuanoIcon />, videoUrl: "https://videos.pexels.com/video-files/4434230/4434230-hd_1920_1080_25fps.mp4" },
    { name: "GibraltarGate.com", url: "GibraltarGate.com", model: "Plataforma de servicios de gestoría y consultoría para empresas y particulares en Gibraltar.", market: "Servicios financieros, creación de empresas, asesoría fiscal.", advantage: "Agiliza la burocracia transfronteriza y ofrece acceso a expertos locales.", projection: "500 operaciones anuales.", revenue: 3, icon: <GibraltarGateIcon />, videoUrl: "https://videos.pexels.com/video-files/3254013/3254013-hd_1920_1080_24fps.mp4" },
    { name: "Tu Rincón Gourmet", url: "TuRinconGourmet.com", model: "Club de suscripción y e-commerce de productos artesanales y gourmet seleccionados.", market: "Amantes de la gastronomía, regalos corporativos, mercado premium.", advantage: "Curación experta de productos exclusivos y storytelling de productores locales.", projection: "10.000 suscriptores activos.", revenue: 4, icon: <TuRinconGourmetIcon />, videoUrl: "https://videos.pexels.com/video-files/5776269/5776290-hd_1920_1080_25fps.mp4" },
  ],
  marketAnalysis: [
